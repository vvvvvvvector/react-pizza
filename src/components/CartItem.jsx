...
export const CartItem = ({ type, diameter, name, cost, amount, imageURL, onRemove }) => {
    ...
    return (
        <div className="cart-item">
            ...
            <div className="amount">
                <button disabled={amount === 1} className={amount > 1 ? "active" : ""} onClick={onClickMinus}>
                ...
                <b>{amount}</b>
                <button className="active" onClick={onClickPlus}>

        ...
        <div className="pizza-component-parent">
            <div className="pizza-component">
                ...
                <div className="pizza-component__bottom">
                    ...
                    <button disabled={amount >= 99} onClick={onClickAdd} className="button button--default">
                        ...
                        <span>{amount >= 99 ? "MAX" : "Add"}</span>
                        {amount > 0 && <Counter counterStyle={"counter__pizza"} amount={amount} />}
                    </button>
                </div>
            </div>
        </div>
